...
\begin{document}
	...
	Dalam tugas akhir kali ini, dua algoritma \textit{Temporal-Difference} (TD) klasik berbasis nilai (\textit{value-based}), yaitu SARSA dan Q-Learning, akan diimplementasikan secara mandiri untuk mengevaluasi perbedaan mendasar pada perilakunya.
